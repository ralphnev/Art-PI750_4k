...
// Screenbuffer
__attribute__((section(".i2c_buffer"))) uint8_t SSD1306_Buffer[SSD1306_BUFFER_SIZE];
__attribute__((section(".i2c_buffer"))) uint8_t D3command;
